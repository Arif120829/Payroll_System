...
class short_leave_controller extends Controller
{
    public function index()
    {
           ...
           $tbl_leave=shortleave::join('employees', 'shortleaves.employeeId' ,'=' , 'employees.employeeId')
           ->select('shortleaves.*', 'employees.name')->get();
   
           return view('settings.shortLeave.short_leave_list',compact('tbl_leave'));
    ...
    public function create()
    {
        ...
        return view('settings.shortLeave.add', compact('tbl_emp'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('shortleave_list_route');
        //return back();
    ...
    public function show($id)
    {
        ...
        return view('settings.shortLeave.view',compact('leave_info'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('settings.shortLeave.edit',compact('leave_info','employee_Info'));
    }
