            ...
            <div class="card card-primary">
              ...
              <form method="post" action="{{ route('update_designation') }}" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" class="form-control" id="name" name="name" placeholder="Designaton Name" value="{{ $desination_info->desig_name }}" >
                  </div>  

                  <div class="form-group">
                    <label for="code">Description</label>
                    <input type="text" autocomplete="off" class="form-control" id="Description" name="Description" placeholder="Enter Designation Info" value="{{ $desination_info->desig_description }}">
                  </div>  

                <div class="form-group">
                    <label for="address">Designation Rank</label>
                    <input type="number" autocomplete="off" class="form-control" id="rank" name="rank" placeholder="Enter Designation Rank" value="{{ $desination_info->desig_rank }}">
                  </div>  
