        ...
        <div class="card card-primary">
          ...
          <form method="post" action="{{ route('update_shortleave') }}" onsubmit = "return validateForm()">
                  ...
                  <div class="form-group">
                    ...
                    <select name="employeeId" id="employeeId" class="form-control">
                        ...
                        @foreach($employee_Info as $com)
                            <option <?php if($com->employeeId==$leave_info->employeeId) echo 'selected'; ?> value="{{ $com->employeeId }}">{{ $com->name }} ({{ $com->employeeId }})</option>
                        @endforeach
                    </select>
            ...
            <div class="card-footer">
              ...
              <a href="{{ route('shortleave_list_route') }}">  <button type="button" class="btn btn-primary">Go Back</button> </a>
